...
namespace YOGESH_INVOICE.DAL
{
    ...
    {
        public String NumWordsWrapper(int number)
        {
        //    string words = "";
        //    double intPart;
        //    double decPart = 0;
        ...
        //    string[] suffixesArr = new string[] { "Thousand", "Lack", "Billion", "Trillion", "Quadrillion", "Quintillion", "Sextillion", "Septillion", "Octillion", "Nonillion", "Decillion", "Undecillion", "Duodecillion", "Tredecillion", "Quattuordecillion", "Quindecillion", "Sexdecillion", "Septdecillion", "Octodecillion", "Novemdecillion", "Vigintillion" };
        //    string words = "";
        ...
        //    return words;
            ...
            if ((number / 1000000) > 0)
            {
                words += NumWordsWrapper(number / 1000000) + " LACK ";
                number %= 1000000;
            }
            if ((number / 1000) > 0)
            {
