...
namespace NewStarCity
{
    public partial class POFormPrint : System.Web.UI.Page
    {
        ...
        public void Get()
        {
            ...
            {
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/SparkInvoice.rdlc");
            }

            Purches_Order_Management objPurchase = new Purches_Order_Management();
            objPurchase.Purchaseorder_Id = Convert.ToInt32(Request.QueryString["po_no"]);
            ...
            objProduct.PurchaseOrder_Id = Convert.ToInt32(Request.QueryString["po_no"]);
